...
const Home = () => {
  ...
  const { notes, setTitle, setDescription, setTag, handleSubmit, isAlert, setIsAlert, alertMessage, alertColor, allTags, setShowTag, setImage, isNoteAdded, loading } = context
